...
do
	#for Vg in -0.02
	for Vg in -0.02 -0.04 -0.06 -0.08 -0.1 -0.12 -0.14 -0.16 -0.18 -0.2 -0.22 -0.24 -0.26 -0.28 0 0.02 0.04 0.06 0.08 0.1 0.12 0.14 0.16 0.18 0.2 0.22 0.24 0.26 0.28
	do
		awk '{print NR,"        ",$1,"        ",$2,"        ",$2-0.5,"        ",sqrt(($2-0.5)*($2-0.5))}' S_h${h}_Vg${Vg} > disordered
